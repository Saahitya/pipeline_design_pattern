...
pipeline: main.o multiply.o add.o pipeline.o stage.o open_file.o save_file.o blur_img.o
	$(CXX) -o pipeline main.o pipeline.o multiply.o add.o stage.o open_file.o save_file.o blur_img.o $(CXXFLAGS)
